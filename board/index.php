...
// 페이징 정렬
if($page_no > 5) {
    $start_page_block = $page_no - 4;
    if($page_no + 5 < $max_page_no) {
        $end_page_block = $page_no +5;
    } else {
        $start_page_block = $end_page_block - 9;
    }
}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-subject">
                                ...
                                <a href="<?=$_board_options["viewPage"]?>?idx=<?=$article_list[$i]["idx"]?>&page_no=<?=$page_no?>&q=<?=$q?>">
